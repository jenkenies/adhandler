...
SERVER_NAME=adhandler
CLASS_PATH=com.utstar.adhandler.AdhandlerApplication
...
STDOUT_FILE=$LOGS_DIR/adhandler.log

LIB_DIR=$DEPLOY_DIR/adhandler-1.0-SNAPSHOT.jar
